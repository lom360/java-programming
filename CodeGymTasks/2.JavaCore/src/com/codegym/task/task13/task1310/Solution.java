...
/* 
Who's that smarty?
1. Add the Secretary and Boss interfaces to the CleverMan and SmartGirl classes. One interface for each class. Think about which interface should go to each class.
