...
7. The Euro, Ruble, and USD classes must implement a public constructor with one double parameter. This constructor must set the value of the Money class's field amount by calling the parent class's constructor with the same argument.
*/
...
public class Solution {
    ...
    static class Person {
        ...
        Person(String name) {
            ...
            this.allMoney.add(new USD(1.00));
            this.allMoney.add(new Euro(0.50));
            this.allMoney.add(new Ruble(0.00));
        }
